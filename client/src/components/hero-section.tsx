...
export default function HeroSection() {
  return (
    <section className="bg-background pt-28 pb-16 lg:pb-24">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="mb-6">
              <div className="mb-4">
                <h1 className="text-5xl lg:text-7xl font-bold text-foreground leading-tight flex items-center justify-center lg:justify-start gap-4">
                  <img
                    src={chessKnightLogo}
              ...
              <h2 className="text-xl lg:text-2xl font-bold text-amber-800 leading-tight">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              ...
              <div className="relative">
                <a
                  ...
                  className="inline-flex items-center justify-center bg-black hover:bg-gray-800 text-white px-6 py-3 rounded-xl font-normal text-base h-auto transition-all duration-300 min-w-[200px] shadow-lg hover:shadow-xl transform hover:scale-105 border border-gray-800"
                >
                  <div className="flex items-center space-x-3">
                    ...
                    <div className="text-left">
                      <div className="text-lg font-semibold leading-tight mt-1">App Store</div>
                    </div>
                  </div>
                </a>
                {/* Badge "Bientôt" */}
              ...
              <div className="relative">
                ...
                >
                  <div className="flex items-center space-x-3">
                    ...
                    <div className="text-left">
                      <div className="text-lg font-semibold leading-tight mt-1">Google Play</div>
                    </div>
                  </div>
                </a>
                {/* Badge "Bientôt" */}
          ...
          >
            ...
            <div className="relative mx-auto w-80 h-[640px] bg-gradient-to-b from-gray-800 to-black rounded-[3rem] p-3 shadow-2xl transform rotate-3 hover:rotate-0 transition-transform duration-500">
              {/* iPhone Screen */}
              <div className="w-full h-full bg-black rounded-[2.5rem] overflow-hidden relative">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-transparent via-transparent to-white/5 pointer-events-none rounded-[2.3rem]"></div>
              </div>
