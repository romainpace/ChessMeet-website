...
export default function DownloadSection() {
  return (
    <section className="py-10 sm:py-12 lg:py-16 bg-foreground text-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          <h2 className="text-2xl xs:text-3xl lg:text-5xl font-bold mb-4 sm:mb-6">Prêt à rejoindre la communauté ?</h2>
          <p className="text-base xs:text-lg sm:text-xl text-white/80 mb-6 sm:mb-8 px-4">
